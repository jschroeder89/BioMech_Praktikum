...
uint32_t constexpr maxTranslation = 250e3; //500
uint32_t constexpr maxRotation = 3.1415927f * 500000.0f * 2.0f; //1.000.000
...
UserThread::main()
{
	//chprintf((BaseSequentialStream*)&global.sercanmux1, "Hello Power Management!\n");
  /*
    ...
    switch (current_state) {
      ...
      case WII_STEERING:
      {
        ...
        // steer AMiRo using the Wiimote controller like a joystick
          ...
          } else if (wii_steering::wiimote.getButtons()->one) {
			  //kinematic.x = wii_steering::maxTranslation * ((wii_steering::wiimote.getButtons()->sy-128)/100)*1.0f;
			  //kinematic.w_z = wii_steering::maxRotation * ((wii_steering::wiimote.getButtons()->sx-128)/100)*1.0f;
          
          } else {
            kinematic = {0, 0, 0, 0, 0, 0};
          }
		  //chprintf((BaseSequentialStream*)&global.sercanmux1, "0x%04X  0x%04X  \n", wii_steering::wiimote.getButtons()->sx, wii_steering::wiimote.getButtons()->sy);
          // set speed
          global.robot.setTargetSpeed(kinematic);
          
          if(wii_steering::colorcycle <= 2048){
            global.robot.setLightColor(constants::LightRing::LED_WNW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_WSW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ENE, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ESE, Color(Color::BLUE));
            wii_steering::colorcycle++; 
			}
          else if (wii_steering::colorcycle <= 4096){
			global.robot.setLightColor(constants::LightRing::LED_WNW, Color(Color::RED));
            global.robot.setLightColor(constants::LightRing::LED_WSW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ENE, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ESE, Color(Color::BLUE));
            wii_steering::colorcycle++;   
		  } else if (wii_steering::colorcycle <= 6144){
			global.robot.setLightColor(constants::LightRing::LED_WNW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_WSW, Color(Color::RED));
            global.robot.setLightColor(constants::LightRing::LED_ENE, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ESE, Color(Color::BLUE));
            wii_steering::colorcycle++;     
		  } else if (wii_steering::colorcycle <= 8192){
			global.robot.setLightColor(constants::LightRing::LED_WNW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_WSW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ENE, Color(Color::RED));
            global.robot.setLightColor(constants::LightRing::LED_ESE, Color(Color::BLUE));  
            wii_steering::colorcycle++;  
		  } else if (wii_steering::colorcycle <= 10240){
			global.robot.setLightColor(constants::LightRing::LED_WNW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_WSW, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ENE, Color(Color::BLUE));
            global.robot.setLightColor(constants::LightRing::LED_ESE, Color(Color::RED)); 
            wii_steering::colorcycle++;   
		  } else{
			wii_steering::colorcycle = 0;
		  }
        }
